...
public class ActitimeCustomerpage extends Basepage implements Autoconstant
{
	...
	public void Customermethod() throws IOException
	{
		...
		entercustomernameTextfield.sendKeys(ExcelLibrary.getcellvalue(excel_path, sheetname1, 1,0));
		customerdescriptionTextfield.sendKeys(ExcelLibrary.getcellvalue(excel_path, sheetname1, 1, 1));
